...
const OfferPackageEditComponent = ({ pkg, onClose, onUpdate, onDelete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex h-screen  items-center justify-center z-999 text-black poppins p-4">
      <motion.div
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center rounded-t-2xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Edit Offer Package</h2>
              <p className="text-gray-600 text-sm">
                Modify offer package details and promotional content
              </p>
            </div>
          </div>
          <button
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="px-3 py-2 bg-green-100 border border-green-300 rounded-lg text-green-700 font-semibold">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  💡 Catchy promotional message for the offer
                </p>
              </div>
            </div>
          </section>
        ...
        {/* Footer Actions */}
        <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 flex justify-between gap-2 items-center rounded-b-2xl">
          <button
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Save changes to this offer package?</p>
              </div>
            </div>
            <p className="text-gray-700 mb-6">
              All modifications will be saved and updated in the system: <strong>{formData.title}</strong>
            </p>
...
export default OfferPackageEditComponent;